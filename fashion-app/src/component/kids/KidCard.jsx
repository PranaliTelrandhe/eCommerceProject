...
import "../kids/KidGallery";

const KidCard = ({ product }) => {
    ...
    return (
        <div className="card kid-card position-relative shadow-sm border-0">
            {/* Product Image */}
            <div className="position-relative">
                ...
                <div className="hover-overlay d-flex flex-column justify-content-center align-items-center">
                    ...
                    <Link to={`/kids/detail/${product.id}`} className="btn btn-outline-light btn-sm mp-10 mr-2 ">
                                            View Details
                                        </Link>
                </div>
            </div>
